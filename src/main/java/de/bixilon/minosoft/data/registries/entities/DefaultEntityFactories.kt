...
object DefaultEntityFactories : DefaultFactory<EntityFactory<*>>(
    ...
    fun buildEntity(factory: EntityFactory<out Entity>, session: PlaySession, position: Vec3d, rotation: EntityRotation, data: EntityData?, uuid: UUID?, versionId: Int): Entity? {
        ...
        val tweakedFactory = this[tweaked]
            ?: factory.takeIf { tweaked == factory.identifier }
            ?: throw UnknownEntityException("Can not find tweaked entity type: $tweaked for $factory")
