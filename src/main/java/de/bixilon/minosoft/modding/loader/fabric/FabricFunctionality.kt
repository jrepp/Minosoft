...
object FabricFunctionalityCatalog {
    ...
    val ENTITY_MODEL_FEATURES = listOf(
        ...
        partial("cem-reload", "CEM generation reload", FabricFunctionalityArea.RELOAD, "CPU candidates are all-or-nothing; retired skeletal models reject new instances and defer GPU mesh disposal until their final retained instance closes. Live render-thread re-bake/swap and repeated real-GL accounting remain.", "ContentGenerationStore / BakedSkeletalModel.retire"),
    ...
    val ENTITY_TEXTURE_FEATURES = listOf(
        ...
        partial("entity-texture-reload", "Entity texture generation reload", FabricFunctionalityArea.RELOAD, "CPU rules are all-or-nothing; each baked content model leases its exact ETF catalog/cache until final model retirement. Live renderer material swap and repeated real-GL disposal proof remain.", "BakedSkeletalModel.contentLease / ContentGenerationStore"),
    ...
    val GECKOLIB = listOf(
        ...
        partial("gecko-reload", "GeckoLib generation reload", FabricFunctionalityArea.RELOAD, "CPU geometry/animation candidates are all-or-nothing, matching clips attach before publication, and retired skeletal GPU meshes survive active instances then dispose on final release; controller migration, live render swap, and repeated real-GL accounting remain.", "ContentFidelityLoader / BakedSkeletalModel.retire"),
