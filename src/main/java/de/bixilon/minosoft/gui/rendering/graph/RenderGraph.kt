...
enum class RenderPhase {
    ...
    IRIS_BEGIN,
    SHADOW,
    IRIS_SHADOW_COMPOSITE,
    IRIS_PREPARE,
    SKY,
    DISTANT_TERRAIN,
    DISTANT_DEPTH_BEFORE_TRANSLUCENT,
    DISTANT_WATER,
    WORLD_OPAQUE,
    ENTITIES,
    BLOCK_ENTITIES,
    PARTICLES_OPAQUE_BEFORE_DEFERRED,
    DEPTH_BEFORE_TRANSLUCENT,
    ENTITIES_TRANSLUCENT_BEFORE_DEFERRED,
    BLOCK_ENTITIES_TRANSLUCENT_BEFORE_DEFERRED,
    PARTICLES_TRANSLUCENT_BEFORE_DEFERRED,
    IRIS_DEFERRED,
