...
execute if score @s aj.walk.frame matches -1 run function aj:armor_stand_minimal/animations/walk/zzz/function_keyframe_loop_patch
data remove storage animated_java:temp args
execute store result storage animated_java:temp args.frame int 1 run scoreboard players get @s aj.walk.frame
function aj:armor_stand_minimal/animations/walk/zzz/apply_frame with storage animated_java:temp args
