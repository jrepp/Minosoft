...
function aj:armor_stand_minimal/animations/pause_all
...
execute at @s run function aj:armor_stand_minimal/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function aj:armor_stand_minimal/animations/walk/zzz/apply_frame {frame: $(to_frame)}
