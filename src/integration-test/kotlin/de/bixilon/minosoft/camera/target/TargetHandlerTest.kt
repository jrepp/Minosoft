...
class TargetHandlerTest {
    ...
    fun first() {
        ...
        session.world[7, 68, 5] = TestBlockStates.OPAQUE1
        session.world[8, 69, 5] = TestBlockStates.OPAQUE1
        session.world[7, 69, 6] = TestBlockStates.OPAQUE2
        session.world[8, 69, 6] = TestBlockStates.OPAQUE1
        ...
        assertEquals(target.state, TestBlockStates.OPAQUE2)
    ...
    fun front() {
        ...
        session.world[8, 70, 2] = TestBlockStates.OPAQUE1
        ...
        assertEquals(target.state, TestBlockStates.OPAQUE1)
    ...
    fun inBlock() {
        ...
        session.world[9, 70, 2] = TestBlockStates.OPAQUE1
