        ...
        val CUBE_ALL_MODEL: BlockModel by lazy {
            BlockModel(
                ...
                elements = listOf(ModelElement(
                    ...
                    to = Vec3f(1, 1, 1),
                    faces = mapOf(
                        Directions.DOWN to ModelFace("#down", null, 0, -1, Directions.DOWN),
                        Directions.UP to ModelFace("#up", null, 0, -1, Directions.UP),
                        Directions.NORTH to ModelFace("#north", null, 0, -1, Directions.NORTH),
                        Directions.SOUTH to ModelFace("#south", null, 0, -1, Directions.SOUTH),
                        Directions.WEST to ModelFace("#west", null, 0, -1, Directions.WEST),
                        Directions.EAST to ModelFace("#east", null, 0, -1, Directions.EAST),
                    ),
                    shade = true,
                    rotation = null,
                )),
